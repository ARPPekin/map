...
const i18n = {
  ...
  zh: {
    ...
    artistsText: '<img src="bb.jpg" alt="Beata Bojda"><p><strong>Beata Bojda </strong></p><p>波兰时装与纺织品设计师。其作品将当代设计与源自民间文化、手工艺及传统装饰技法的灵感相结合。她的创作以大胆的色彩搭配、装饰性以及对细节的精雕细琢而著称，形成了独特且具有辨识度的视觉语言。</p><p>在她的创作中，与传统的对话占据核心地位。她从波兰民间艺术中汲取灵感——如科尼亚库夫蕾丝（Koniaków lace）和沙莫图维刺绣（Szamotuły embroidery）——并赋予当代且个性化的表达，而非简单复刻。</p><p>她的设计秉持责任感与可持续的理念：既使用新面料，也运用旧织物，常常赋予其“第二次生命”。 她的作品多在本地裁缝工坊以小批量方式制作完成。</p><p>Beata Bojda的作品体现了现代与传统的融合——手工艺、历史与当代设计相互交融的美学，创造出富有表现力且经久不衰的艺术形式。</p><p><strong>An On Bast & Daga Gregorowicz</strong></p><p>来自波兰的双人音乐组合， 融合了电子音乐、富有表现力的人声以及世界音乐元素。其音乐风格游走于氛围音乐（ambient）、浩室（house）与科技舞曲（techno）之间，并融入民族音乐元素与即兴创作。</p><img src="aob.jpg" alt="An On Bast"><p><strong>An On Bast</strong>——音乐制作人及DJ，是波兰电子音乐领域具有代表性的艺术家之一。她以充满能量的即兴现场演出著称，擅长运用模拟乐器进行实时创作。</p><img src="daga.jpg" alt="Daga Gregorowicz"><p><strong>Daga Gregorowicz</strong>——歌手、作曲家及词作者，乐队Dagadana的联合创始人。她的作品融合了民间音乐元素与现代电子音乐，其极具辨识度且层次丰富的嗓音是其艺术表达的核心。</p><p>该组合的演出具有强烈的现场表演性——充满活力且富有即兴色彩的演出，在现代电子音乐与有机人声表达之间构建出富有张力的舞台体验。</p>',
