...
const i18n = {
  pl: {
    ...
    attractionsCaption: '<img src="mapa_PL.PNG" alt="Mapa wydarzenia">',
  ...
  en: {
    ...
    attractionsCaption: '<img src="mapa_EN.png" alt="Map of event">',
  ...
  zh: {
    ...
    attractionsCaption: '<img src="mapa_CN.png" alt="活动区域地图 / 分区图">',
    foodCaption: '餐饮区地图',
